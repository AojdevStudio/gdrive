  ...
  return {
    ...
    gmail: [
      ...
      },
      {
        ...
        description: 'List attachment metadata for a message: attachmentId, filename, mimeType, and size. Use downloadAttachment for raw content or readAttachmentText for decoded text.',
