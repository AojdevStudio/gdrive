...
export const SDK_SPEC: SDKSpec = {
  ...
  gmail: {
    ...
    createDraft: {
      signature: "createDraft(options: { to: string | string[], subject: string, body: string, cc?: string | string[], bcc?: string | string[], inReplyTo?: string }): Promise<{ draftId, messageId, threadId }>",
      description: "Create an email draft (not sent). Use sendDraft() to send it.",
      example: "const draft = await sdk.gmail.createDraft({\n  to: 'team@company.com',\n  subject: 'Weekly Update',\n  body: 'Hi team,\\n\\nHere is this week\\'s update...'\n});\nreturn draft.draftId;",
      params: {
    ...
    sendMessage: {
      signature: "sendMessage(options: { to: string | string[], subject: string, body: string, cc?: string | string[], bcc?: string | string[], inReplyTo?: string }): Promise<{ messageId, threadId, labelIds }>",
